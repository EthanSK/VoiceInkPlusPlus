...
row, and suppresses only the completed Primary modifier chord. All three user-facing changes remain
candidate behavior until their physical traces/checks pass; do not replace the accepted v2.0.245
Telegram evidence or v2.0.243 Primary checkpoint with unit-test inference.
